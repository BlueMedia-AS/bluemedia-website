...
import { manifest, about } from '../content/no'

export default function Manifest() {
  return (
    <Section id="visjon" className="min-h-screen flex flex-col justify-center">
      <Container>
        {/* Visjon — left aligned */}
        <div>
          ...
          <Reveal variant="scaleIn" delay={0.2}>
            ...
            >
              <HighlightedText text={manifest.title} delay={3.5} />
            </h2>
          </Reveal>
        ...
        {/* Om BlueMedia — right aligned */}
        <div id="om" className="mt-24 flex flex-col items-end text-right">
          <Reveal variant="fadeUp" delay={0.2}>
            <h2
              className="mt-6 max-w-2xl font-bold leading-[var(--leading-snug)] tracking-[var(--tracking-tight)]"
              style={{ fontSize: 'var(--text-h2)' }}
            >
              <HighlightedText text={about.title} delay={12} />
            </h2>
          </Reveal>
